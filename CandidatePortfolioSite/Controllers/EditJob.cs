...
{
    public class EditJob : Controller
    {
        string baseURL3 = "https://localhost:44336/api/CandidatesAPIContext/:id";
        public async Task<ActionResult<String>> EditJobs(Candidates candidate)
        {
        ...
        public IActionResult EditJobView(Candidates candidate)
        {
            Candidates obj = new Candidates()
            {
